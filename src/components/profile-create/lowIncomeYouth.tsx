...
const LowIncomeYouthCreationForm = forwardRef<ProfileFormHandle, ProfileFormProps>(({ onSubmit }, ref) => {
    ...
    return (
        <form>
            ...
            <Grid>
                ...
                <Grid.Col span={6}>
                    <TextInput required label="Carteira de identidade Jovem" key={form.key('youthIdentityCard')} {...form.getInputProps('youthIdentityCard')} />
                </Grid.Col>
                <Grid.Col span={6}>
...
export default LowIncomeYouthCreationForm;